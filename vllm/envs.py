...
if TYPE_CHECKING:
    ...
    VLLM_ACTIVATION_SHAPE_EVENTS: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Emit torch.profiler events with activation tensor shapes for model layers
    "VLLM_ACTIVATION_SHAPE_EVENTS": lambda: bool(
        int(os.getenv("VLLM_ACTIVATION_SHAPE_EVENTS", "0"))
    ),
