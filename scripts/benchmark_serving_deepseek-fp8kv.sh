...
num_prompts=448
request_rate=16
log_name="[0306-staticquant-fp8kv]online-gaudi3-${gpu_utils}util-TPparallel${tp_parrallel}-${moe_n_slice}moegroups_nprompt${num_prompts}_rrate${request_rate}_bs${bs}_i${in_len}_o${out_len}_mdllen${total_len}"
