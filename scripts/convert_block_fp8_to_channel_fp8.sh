...
original_model_path=/lkk/DeepSeek-R1  # origin fp8 provided by deepseek.
output_model_root=/lkk
dynamic_model_path=${output_model_root}/DeepSeek-R1-G3-dynamic
static_model_path=${output_model_root}/DeepSeek-R1-G3-static
